...
const config = {
  ...
  organizationName: '920oj', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/920oj-net-ogp.png',
      navbar: {
        title: '920oj.net',
        logo: {
          alt: 'Site Logo',
          src: 'img/logo-white_only.png',
        },
        items: [
          {
            to: '/introduction',
          ...
          {
            href: 'https://github.com/920OJ/920oj-net',
            label: 'GitHub',
            position: 'right',
          },
        ],
